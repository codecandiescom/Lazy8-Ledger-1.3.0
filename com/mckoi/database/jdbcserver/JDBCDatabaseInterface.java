...
//    // Set the user and database that is executing the command on this
//    // thread...
//    UserWorkerThread thread = (UserWorkerThread) Thread.currentThread();
//    thread.setUser(user);
//    thread.setDatabaseConnection(database_connection);
    ...
    if (Debug().isInterestedIn(Lvl.INFORMATION)) {
      Debug().write(Lvl.INFORMATION, this,
                  "Query From User (" + user.getUserName() + ")");
      Debug().write(Lvl.INFORMATION, this,
...
//    // thread...
//    UserWorkerThread thread = (UserWorkerThread) Thread.currentThread();
//    thread.setUser(getUser());
//    thread.setDatabaseConnection(getDatabaseConnection());
