...
public class CorrelatedVariable implements Cloneable {
   ...
   */
  private Object eval_result;

  /**
   * The class this variable evaluates to.
   */
  private Class eval_class;
   ...
   */
  public void setEvalResult(Class clazz, Object ob) {
    this.eval_class = clazz;
    this.eval_result = ob;
  }
  ...
  public void setFromResolver(VariableResolver resolver) {
    ...
    setEvalResult(resolver.classType(v), resolver.resolve(v));
  }
  ...
  /**
   * Returns the class this correlated variable evaluates to.
   */
