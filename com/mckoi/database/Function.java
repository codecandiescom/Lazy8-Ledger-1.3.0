...
public interface Function {
  ...
  /**
   * Evaluates the function and returns an Object that represents the result
  ...
  /**
   * The class of object this function returns.  eg. BigDecimal.class,
   * String.class, etc.  The VariableResolver points to a dummy row that can
