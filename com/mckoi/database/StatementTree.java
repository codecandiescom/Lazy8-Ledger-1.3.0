...
//  /**
//   * Resolves the variable substitutions in this statement tree by searching
//   * through the expression objects and resolving them to the given list of
//   * parameters.
//   * <p>
//   * Note that even after this method has been called this StatementTree should
//   * continue to be serializable provided the given parameters are
//   * serializable.
//   */
//  public void resolveSubstitutions(Object[] parameters) {
...
//  /**
//   * Prepares all the functions in all the expression in this statement.  This
//   * method must be called after any other statement tree preparations.
//   */
//  public void prepareAllFunctions(final FunctionLookup lookup)
//                                                  throws DatabaseException {
//    prepareAllExpressions(new ExpressionPreparer() {
//      public boolean canPrepare(Object ob) {
//        return (ob instanceof FunctionDef);
//      }
//      public Object prepare(Object element) throws DatabaseException {
//        FunctionDef fdef = (FunctionDef) element;
//        Function f = lookup.generateFunction(fdef);
//        if (f != null) {
//          return f;
//        }
...
////      Expression exp = (Expression) expression_list.get(i);
////      exp.prepareFunctions(lookup);
////    }
//  }
