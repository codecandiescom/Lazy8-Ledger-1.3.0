...
public class QueryPlan {
  ...
  public static class FetchTableNode implements QueryPlanNode {
    ...
    public FetchTableNode(TableName table_name, String aliased_as) {
  ...
  public static class SingleRowTableNode implements QueryPlanNode {
    ...
    public Table evaluate(QueryContext context) {
      return FunctionTable.SINGLE_ROW_TABLE;
    }
  ...
  public static class RangeSelectNode extends SingleQueryPlanNode {
    ...
    private void updateRange(QueryContext context, SelectableRangeSet range,
                             TableField field, Expression e) {
      Operator op = (Operator) e.last();
      Expression[] exps = e.split();
      // Evaluate to an object
      Object ob = exps[1].evaluate(null, null, context);
      // Make into a DataCell
      DataCell cell = DataCellFactory.generateDataCell(field, ob);
    ...
    public Table evaluate(QueryContext context) {
      ...
      TableField field = t.getFieldAt(col);
      // Calculate the range
  ...
  public static class SimplePatternSelectNode extends SingleQueryPlanNode {
    ...
    public Table evaluate(QueryContext context) {
      ...
      if (lhs_var != null) {
        ...
        Object v = expression.evaluate(null, context);
        // If it evaluates to NULL or FALSE then return an empty set
        if (v == null || v instanceof NullObject ||
            v.equals(Boolean.FALSE)) {
...
//    /**
//     * If this is not null, then the resulting names are set to this
//     * TableName.
//     */
//    private TableName given_name;
...
//        System.out.print(t.getResolvedVariable(n));
//        System.out.print(", ");
//      }
//      System.out.println();
//      // - DEBUG
...
//        // DEBUG
//        System.out.println(original_columns[i]);
//        // - DEBUG

        col_map[i] = t.findFieldName(original_columns[i]);

//        // DEBUG
//        System.out.println("found: " + col_map[i]);
//        // - DEBUG
...
//      given_name = name;
  ...
  public static class CreateFunctionsNode extends SingleQueryPlanNode {
    ...
    public Table evaluate(QueryContext context) {
      ...
      FunctionTable fun_table =
          new FunctionTable(child_table, function_list, name_list, db_context);
      return fun_table.mergeWithReference(null);
    }
    ...
    public Table evaluate(QueryContext context) {
      ...
      if (rhs_var != null) {
        ...
        if (left_result.getRowCount() < right_result.getRowCount()) {
          // Reverse the join
          right_expression = new Expression(left_var);
          left_var = rhs_var;
          join_op = join_op.reverse();
          // Reverse the tables.
      ...
      return left_result.simpleJoin(context, right_result,
                                    left_var, join_op, right_expression);
    }
