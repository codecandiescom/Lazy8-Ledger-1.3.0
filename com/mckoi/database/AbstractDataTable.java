...
public abstract class AbstractDataTable extends Table implements RootTable {
  ...
  /**
   * A DataTable has a name which can be accessed via this method.
   */
  ...
  public TableName getTableName() {
    ...
    if (table_def == null) {
      return new TableName(getName());
    }
    else {
      return table_def.getTableName();
    }
  }
  ...
  public boolean typeEquals(RootTable table) {
    ...
    return (getName().equals(dest.getName()));
  }
