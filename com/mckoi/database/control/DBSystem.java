...
public final class DBSystem {
   ...
   * the database.
   *
   * @returns a Database object that can be used to access the database system
   *   at a low level.
   */
   ...
   * connection.  For this reason certain database congifuration constraints
   ...
   * @returns a JDBC java.sql.Connection used to access the database.
   */
  public Connection getConnection(String username, String password)
    ...
    connection.login(null, username, password);
