...
//  /**
//   * The query string that evaluated to this statement (optional).
//   */
//  private String query_string;
//
//  /**
//   * The query arguments that evaluated to this statement (optional).
//   */
//  private Object[] query_args;
...
//  /**
//   * Sets the query string and query arguments that were used to execute
//   * this statement.
//   */
//  public void setQueryInfo(String query_string, Object[] query_args) {
//    this.query_string = query_string;
//    this.query_args = query_args;
//  }
//
//  /**
//   * Returns the query string that we used to make this statement.
//   */
...
//
//  /**
//   * Returns the query arguments that we used to make this statement.
//   */
//  Object[] getQueryArgs() {
//    return query_args;
//  }
  ...
  public final void resolveTree() throws DatabaseException {
    ...
    // Prepare the functions in all the expression in the StatementTree
    final ExpressionPreparer preparer2 =
                        database.getSystem().getFunctionExpressionPreparer();
//    ExpressionPreparer preparer2 = new ExpressionPreparer() {
//      public boolean canPrepare(Object element) {
...
//      }
//    };
    cmd.prepareAllExpressions(preparer2);

//    cmd.prepareAllFunctions(DatabaseSystem.getFunctionLookup());
  }
...
//  private static final ArrayList EMPTY_ARRAY_LIST = new ArrayList(0);
  ...
  /**
   * Returns true if this statement has to be evaluated under EXCLUSIVE mode.
   * EXCLUSIVE mode means no other threads may execute queries on any table
   * in the transaction until the EXCLUSIVE lock is lost.  This method is
   * called before 'prepare'.
   */
  public abstract boolean isExclusive();

  /**
   * Returns the names of all tables that we read from during the time when
   * the statement is evaluated.  This is called after 'prepare' and before
   * 'evaluate'.  The class of objects in the List must be DataTable objects.
   */
  public abstract List readsFromTables();

  /**
   * Returns the names of all tables that we write to during the time when
   * the statement is evaluated.  This is called after 'prepare' and before
   * 'evaluate'.  The class of objects in the List must be DataTable objects.
   */
  public abstract List writesToTables();
