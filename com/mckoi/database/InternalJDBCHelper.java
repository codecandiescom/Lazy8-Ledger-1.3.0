...
class InternalJDBCHelper {
   ...
   *   be enabled.
   */
  static Connection createJDBCConnection(DatabaseConnection connection) {
    InternalDatabaseInterface db_interface =
                                   new InternalDatabaseInterface(connection);
   ...
   */
  static class InternalDatabaseInterface
     ...
     * Constructor.
     */
    public InternalDatabaseInterface(DatabaseConnection db) {
