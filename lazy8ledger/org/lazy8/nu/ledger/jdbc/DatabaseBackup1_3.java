 ...
 */
public class DatabaseBackup1_3 {
  Connection con;
  ...
  /**
   *  Constructor for the DatabaseBackup1_3 object
   *
   *@param  conin  Description of the Parameter
   */
  public DatabaseBackup1_3(Connection conin) {
    con = conin;
  }
  ...
  public void RestoreDatabase(boolean bRestoreOneCompanyOnly, String fileName, int iNewCompany) {
    ...
    if(SetupInfo.getBoolProperty(SetupInfo.REQUIRE_BACKUP_PASSWORD))
		...
		Translator.getTranslation("The option to have a password encrypted backup is available only in Java version 1.4"),
		Translator.getTranslation("Lazy8Ledger"),
