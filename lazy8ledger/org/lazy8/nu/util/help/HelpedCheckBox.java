 ...
 */
public class HelpedCheckBox extends JCheckBox {
   ...
   *@param  isSet         Description of the Parameter
   */
  public HelpedCheckBox(String Caption, boolean isSet, String helpFieldin,
    ...
    MouseListener l =
      new MouseListener() {
        ...
        public void mouseEntered(MouseEvent e) {
          Lazy8Ledger.ShowContextHelp(HelpedCheckBox.this.view, helpName ,helpField);
        }
