...
public class HelpedRadioButton extends JRadioButton {
   ...
   */
  public HelpedRadioButton(String Caption, String helpFieldin, String helpNamein,JFrame view ) {
    super(Caption);
    this.view=view;
    helpName = helpNamein;
    ...
    MouseListener l =
      new MouseListener() {
        ...
        public void mouseEntered(MouseEvent e) {
          Lazy8Ledger.ShowContextHelp(HelpedRadioButton.this.view, helpName ,helpField);
        }
